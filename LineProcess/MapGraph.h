...
public:
	...
	void DisplayGraph();
	void DeepFirstSearch(int StartNodeID, int EndNodeID);
	void BreadthFirstSearch(int StartNodeID, int EndNodeID);
	//void CreateGraph();
	...
	vector<PointXY> GenerateBezier(PointXY* Anchor1, PointXY* Anchor2, int pointNum);
private:
	void DFS(int v);
	void BFS(int v);
