...
{
	//fprintf(stderr, "Error: %s, at file: %s, function: %s, line:%d, system error info: %s\n", pcErrorInfo, pcFilePath, pcFunctionName, nLineNumber, std::strerror_s(nSystemErrorNo));
	printf("Error: %s, at file: %s, function: %s, line:%d\n", pcErrorInfo, pcFilePath, pcFunctionName, nLineNumber);
	return;
}
...
inline void PrintWarningInfo(const char *pcWarningInfo, const char *pcFilePath, const char *pcFunctionName, const int nLineNumber)
{
	...
	printf("Warning: %s, at file: %s, function: %s, line: %d", pcWarningInfo, pcFilePath, pcFunctionName, nLineNumber);
	return;
}
...
inline void PrintStatusInfo(const char *pcStatusInfo, const char *pcFilePath, const char *pcFunctionName, const int nLineNumber)
{
	...
	printf("Status: %s, at file: %s, function: %s, line: %d", pcStatusInfo, pcFilePath, pcFunctionName, nLineNumber);
	return;
}
